...
/***/ "./node_modules/css-loader/index.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/less-loader/dist/cjs.js!./src/less/template.less":
/*!*******************************************************************************************************************************************************!*\
...
var _display = __webpack_require__(/*! ./display/display */ "./src/js/components/display/display.js");
...
var App = function (_Component) {
    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_display2.default, null);
        }
    }]);
...
/***/ "./src/js/components/display/display.js":
/*!**********************************************!*\
  !*** ./src/js/components/display/display.js ***!
  \**********************************************/
/*! no static exports found */
...
var _header = __webpack_require__(/*! ./header */ "./src/js/components/display/header.js");

var _header2 = _interopRequireDefault(_header);

var _footer = __webpack_require__(/*! ./footer */ "./src/js/components/display/footer.js");

var _footer2 = _interopRequireDefault(_footer);

var _toolbar = __webpack_require__(/*! ./toolbar */ "./src/js/components/display/toolbar.js");

var _toolbar2 = _interopRequireDefault(_toolbar);

var _grid = __webpack_require__(/*! ./grid */ "./src/js/components/display/grid.js");

var _grid2 = _interopRequireDefault(_grid);

var _infobar = __webpack_require__(/*! ./infobar */ "./src/js/components/display/infobar.js");

var _infobar2 = _interopRequireDefault(_infobar);

var _tablo = __webpack_require__(/*! ./tablo */ "./src/js/components/display/tablo.js");
...
var Display = function (_Component) {
    ...
    function Display(props) {
        ...
        _this.state = {
            ...
            quotesSwitchedOff: _this.defaultSettings.quotesSwitchedOff,
            userColor: _this.defaultSettings.userColor,
            boardSize: _this.defaultSettings.boardSize,
            level: _this.defaultSettings.level,
            mode: _this.defaultSettings.mode,
            currentActionDefinition: _this.defaultSettings.currentActionDefinition,
            startOfGame: _this.defaultSettings.startOfGame,
            endOfGame: _this.defaultSettings.endOfGame,
            isUserTurn: _this.defaultSettings.isUserTurn,
            currentUserTurn: _this.defaultSettings.currentUserTurn,
            currentAITurn: _this.defaultSettings.currentAITurn,

            movesCount: _this.defaultSettings.movesCount,
            whiteActorsCount: _this.defaultSettings.whiteActorsCount,
            blackActorsCount: _this.defaultSettings.blackActorsCount,
            totalOfGame: _this.defaultSettings.totalOfGame
        };

        _this.drawMarks = _this.drawMarks.bind(_this);
        _this.switchStartGame = _this.switchStartGame.bind(_this);
        _this.updateData = _this.updateData.bind(_this);
        _this.resetDisplay = _this.resetDisplay.bind(_this);
        _this.resetDefaultSettings = _this.resetDefaultSettings.bind(_this);
        _this.createTurnDefinition = _this.createTurnDefinition.bind(_this);
        _this.turnIsDone = _this.turnIsDone.bind(_this);
        return _this;
    }
    ...
    _createClass(Display, [{
        ...
        value: function drawMarks() {
            var boardSize = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.state.boardSize;
            ...
            for (var i = 0; i < boardSize; i++) {
                ...
                this.state.marks.horizontal.push(_react2.default.createElement(
                    'span',
                    null,
                    this.marksSymbols.horizontal[i]
                ));
                this.state.marks.vertical.push(_react2.default.createElement(
                    'span',
                    null,
                    this.marksSymbols.vertical[i]
                ));
            }
        }
        ...
        key: 'updateData',
        value: function updateData(data, value) {
        ...
        key: 'switchStartGame',
        value: function switchStartGame(event) {
            ...
            //завершить игру
                    ...
                    if (!event) {
                        ...
                        if (this.state.userColor == 'white' && this.state.whiteActorsCount == 0 || this.state.userColor == 'black' && this.state.blackActorsCount == 0) {
        ...
        key: 'resetDisplay',
        value: function resetDisplay(event) {
        ...
        key: 'createTurnDefinition',
        value: function createTurnDefinition(currentPosition, newPosition, actor, eatenActor, turnedToDam) {
            ...
            definition += ' перемещена с клетки ' + currentPositionMarks.markX + currentPositionMarks.markY + ' на клетку ' + newPositionMarks.markX + newPositionMarks.markY + '.';
        ...
        key: 'turnIsDone',
        value: function turnIsDone(currentPosition, newPosition, actor, eatenActor, turnedToDam, whiteActorsCount, blackActorsCount) {
            ...
            if (this.state.isUserTurn) {
                ...
                this.state.currentAITurn = {
                    currentPosition: { positionX: 1, positionY: 2 },
                    newPosition: { positionX: 2, positionY: 3 },
                    actor: { color: 'grid__actor_black', type: 'grid__actor_checker' },
                    eatenActor: null,
                    turnedToDam: false
                };
            } else {
        ...
        value: function render() {
            ...
            var pageContentClass = 'page__content content' + (this.state.endOfGame ? ' content_transparent' : '');
            var tabloClass = 'page__tablo ' + (this.state.endOfGame ? 'tablo_shown' : 'tablo_hidden');

            return _react2.default.createElement(
                'div',
                { ref: function ref(elem) {
                        return _this2.page = elem;
                    }, className: 'page' },
                _react2.default.createElement(
                    'div',
                    { className: pageContentClass },
                    _react2.default.createElement(_header2.default, { className: 'content__header', quotesSwitchedOff: this.state.quotesSwitchedOff }),
                    _react2.default.createElement(
                        'div',
                        { className: 'content__main main' },
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'main__chessboard chessboard' },
                            _react2.default.createElement(
                                'div',
                                { className: 'chessboard__marks-container marks-container marks-container_horizontal marks-container_top' },
                                this.state.marks.horizontal
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'chessboard__marks-container marks-container marks-container_horizontal marks-container_bottom' },
                                this.state.marks.horizontal
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'chessboard__marks-container marks-container marks-container_vertical marks-container_left' },
                                this.state.marks.vertical
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'chessboard__marks-container marks-container marks-container_vertical marks-container_right' },
                                this.state.marks.vertical
                            ),
                    ...
                    _react2.default.createElement(_footer2.default, { className: 'content__footer' })
                ),
                _react2.default.createElement(_tablo2.default, {
...
/***/ "./src/js/components/display/footer.js":
/*!*********************************************!*\
  !*** ./src/js/components/display/footer.js ***!
  \*********************************************/
/*! no static exports found */
...
/***/ "./src/js/components/display/grid.js":
/*!*******************************************!*\
  !*** ./src/js/components/display/grid.js ***!
  \*******************************************/
/*! no static exports found */
...
var Cell = function (_Component) {
	...
	function Cell(props) {
		...
		_this.addUserFunctionality = _this.addUserFunctionality.bind(_this);
		_this.removeUserFunctionality = _this.removeUserFunctionality.bind(_this);
		_this.chooseCellToMoveActor = _this.chooseCellToMoveActor.bind(_this);
		return _this;
	}
	...
	_createClass(Cell, [{
		key: 'chooseCellToMoveActor',
		value: function chooseCellToMoveActor(event) {
		...
		key: 'addUserFunctionality',
		value: function addUserFunctionality() {
		...
		key: 'removeUserFunctionality',
		value: function removeUserFunctionality() {
		...
		value: function render() {
			...
			var cellClass = 'grid__cell ' + (this.props.className ? this.props.className : '');

			return _react2.default.createElement(
				'td',
				{ ref: function ref(elem) {
						return _this2.ref = elem;
					}, className: cellClass },
...
var Actor = function (_Component2) {
	_inherits(Actor, _Component2);

	function Actor(props) {
		_classCallCheck(this, Actor);

		var _this3 = _possibleConstructorReturn(this, (Actor.__proto__ || Object.getPrototypeOf(Actor)).call(this, props));
		...
		_this3.deselect = _this3.deselect.bind(_this3);
		_this3.chooseActorToMove = _this3.chooseActorToMove.bind(_this3);
		_this3.addUserFunctionality = _this3.addUserFunctionality.bind(_this3);
		_this3.removeUserFunctionality = _this3.removeUserFunctionality.bind(_this3);
		return _this3;
	}
	...
	_createClass(Actor, [{
		...
		key: 'chooseActorToMove',
		value: function chooseActorToMove(event) {
		...
		value: function shouldComponentUpdate(nextProps, nextState) {
			...
			return (
				...
				nextProps.className !== this.props.className || nextState.className !== this.state.className ||
		...
		value: function componentWillUpdate(nextProps) {
			if (nextProps.className !== this.props.className) this.state.className = nextProps.className;
		}
	}, {
		key: 'componentDidUpdate',
		value: function componentDidUpdate(prevProps) {
		...
		value: function componentDidMount() {
			...
			if (this.props.isUserColor && !this.props.passive) this.addUserFunctionality();
		}
	}, {
		key: 'render',
		value: function render() {
			...
			var actorClass = 'grid__actor ' + (this.state.className ? this.state.className : '');

			return _react2.default.createElement('div', { ref: function ref(elem) {
					return _this4.ref = elem;
...
var Grid = function (_Component3) {
	...
	function Grid(props) {
		...
		var _this5 = _possibleConstructorReturn(this, (Grid.__proto__ || Object.getPrototypeOf(Grid)).call(this, props));

		_this5.whiteActorsCount = 0;
		_this5.blackActorsCount = 0;
		...
		_this5.drawGrid = _this5.drawGrid.bind(_this5);
		_this5.fillGridData = _this5.fillGridData.bind(_this5);
		_this5.drawSelectedCells = _this5.drawSelectedCells.bind(_this5);
		_this5.drawDeselectedCells = _this5.drawDeselectedCells.bind(_this5);
		_this5.chooseActorToMove = _this5.chooseActorToMove.bind(_this5);
		_this5.chooseCellToMoveActor = _this5.chooseCellToMoveActor.bind(_this5);
		_this5.doTurn = _this5.doTurn.bind(_this5);
		_this5.resetAllElements = _this5.resetAllElements.bind(_this5);
		return _this5;
	}
	...
	_createClass(Grid, [{
		key: 'fillGridData',
		value: function fillGridData() {
			var boardSize = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.props.boardSize;
			var mode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.props.mode;
			var userColor = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this.props.userColor;
			var isUserTurn = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : this.props.isUserTurn;

			console.log('fillGridData', boardSize, mode, userColor, isUserTurn);

			// для расстановки белых и черных актеров на доске
			var firstRowWhite = boardSize / 2 + 1;
			var lastRowWhite = boardSize - 1;
			var firstRowBlack = 0;
			var lastRowBlack = boardSize / 2 - 2;
			...
			for (var x = 0; x < boardSize; x++) {
				...
				for (var y = 0; y < boardSize; y++) {
					...
					// клетка
					var cellColor = (x + y) % 2 == 0 ? 'grid__cell_white' : 'grid__cell_black';
					...
					if (cellColor == 'grid__cell_black') {
						...
						if (actorColor) {
							...
							// актер
							var isUserColor = userColor == actorColor;
							// TODO??
							actorColor = 'grid__actor_' + actorColor;
							var actorType = mode == 'classic' ? 'grid__actor_checker' : 'grid__actor_dam';
		...
		key: 'changeActorsCount',
		value: function changeActorsCount() {
			...
			for (var y = 0; y < this.props.boardSize; y++) {
				...
				for (var x = 0; x < this.props.boardSize; x++) {
					...
					if (this.state.actorsDataContainer[x][y]) {
						var actorClassName = this.state.actorsDataContainer[x][y].type + ' ' + this.state.actorsDataContainer[x][y].color;
						var defaultActorClassName = this.state.actorsDataContainer[x][y].defaultColor + ' ' + this.state.actorsDataContainer[x][y].type;

						actor = _react2.default.createElement(Actor, {
							key: actorKey,
					...
					var cell = _react2.default.createElement(Cell, {
						key: cellKey,
		...
		key: 'drawSelectedCells',
		value: function drawSelectedCells(positionX, positionY) {
		...
		key: 'drawDeselectedCells',
		value: function drawDeselectedCells(positionX, positionY) {
		...
		value: function chooseActorToMove(positionX, positionY) {
			...
			for (var y = 0; y < this.props.boardSize; y++) {
				for (var x = 0; x < this.props.boardSize; x++) {
					if (this.state.actorsDataContainer[x][y]) this.state.actorsDataContainer[x][y].passive = true;
				}
			}
		...
		key: 'resetAllElements',
		value: function resetAllElements() {
		...
		key: 'chooseCellToMoveActor',
		value: function chooseCellToMoveActor(newPositionX, newPositionY) {
		...
		key: 'doTurn',
		value: function doTurn(currentPosition, newPosition) {
			console.log('doTurn');

			// подготовка данных для передачи в Display
			var currentActorData = this.state.actorsDataContainer[currentPosition.positionX][currentPosition.positionY];
			...
			var newActorData = this.state.actorsDataContainer[newPosition.positionX][newPosition.positionY];
		...
		value: function componentWillUpdate(nextProps) {
			...
			if (nextProps.boardSize !== this.props.boardSize || nextProps.mode !== this.props.mode || nextProps.userColor !== this.props.userColor || !nextProps.endOfGame && this.props.endOfGame) {
...
/***/ "./src/js/components/display/header.js":
/*!*********************************************!*\
  !*** ./src/js/components/display/header.js ***!
  \*********************************************/
/*! no static exports found */
...
var _quotebar = __webpack_require__(/*! ./quotebar */ "./src/js/components/display/quotebar.js");

var _quotebar2 = _interopRequireDefault(_quotebar);
	...
	_createClass(Header, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(_quotebar2.default, { quotesSwitchedOff: this.props.quotesSwitchedOff })
			);
		}
	}]);
...
/***/ "./src/js/components/display/infobar.js":
/*!**********************************************!*\
  !*** ./src/js/components/display/infobar.js ***!
  \**********************************************/
/*! no static exports found */
...
var Infobar = function (_Component) {
	...
	function Infobar(props) {
		...
		_this.state = {
			currentHours: _this.defaultSettings.currentHours,
			currentMinutes: _this.defaultSettings.currentMinutes,
	...
	_createClass(Infobar, [{
		...
		value: function tick() {
			...
			//???
			var newCurrentHours = newDate.getHours() - this.startTime.getHours();
			var newCurrentMinutes = newDate.getMinutes() - this.startTime.getMinutes();
			if (newCurrentMinutes < 0) newCurrentMinutes = newCurrentMinutes * -1;
		...
		value: function shouldComponentUpdate(nextProps, nextState) {
			...
			return nextState.currentHours !== this.state.currentHours || nextState.currentMinutes !== this.state.currentMinutes || nextProps.currentActionDefinition !== this.state.currentActionDefinition || nextProps.startOfGame !== this.props.startOfGame || nextProps.isUserTurn !== this.props.isUserTurn || nextProps.whiteActorsCount !== this.props.whiteActorsCount || nextProps.blackActorsCount !== this.props.blackActorsCount;
		}
	}, {
		key: 'componentWillUpdate',
		value: function componentWillUpdate(nextProps, nextState) {
		...
		value: function render() {
			...
			var whoTurns = this.props.startOfGame || this.props.endOfGame ? this.props.isUserTurn ? 'ваш' : 'противника' : '-';
			var currentTime = this.state.currentHours + ' ч ' + this.state.currentMinutes + ' мин ';

			return _react2.default.createElement(
				'div',
				{ className: 'bar bar_info' },
				_react2.default.createElement(
					'div',
					null,
					'\u0421\u0435\u0439\u0447\u0430\u0441 \u0445\u043E\u0434: ',
				...
				_react2.default.createElement(
					'div',
					null,
					'\u0411\u0435\u043B\u044B\u0435 \u0444\u0438\u0433\u0443\u0440\u044B \u043D\u0430 \u0434\u043E\u0441\u043A\u0435: ',
					_react2.default.createElement(
						'span',
						null,
						this.props.whiteActorsCount
					)
				),
				_react2.default.createElement(
					'div',
					null,
					'\u0427\u0435\u0440\u043D\u044B\u0435 \u0444\u0438\u0433\u0443\u0440\u044B \u043D\u0430 \u0434\u043E\u0441\u043A\u0435: ',
					_react2.default.createElement(
						'span',
						null,
						this.props.blackActorsCount
					)
				),
				_react2.default.createElement(
					'div',
					null,
					'\u0418\u0441\u0442\u043E\u0440\u0438\u044F \u0445\u043E\u0434\u043E\u0432:',
					_react2.default.createElement('textarea', { readOnly: 'true', value: this.state.currentActionDefinition })
				)
			);
		}
	}]);
...
/***/ "./src/js/components/display/quotebar.js":
/*!***********************************************!*\
  !*** ./src/js/components/display/quotebar.js ***!
  \***********************************************/
/*! no static exports found */
...
// панель с цитатами
var Quotebar = function (_Component) {
	_inherits(Quotebar, _Component);

	function Quotebar(props) {
		_classCallCheck(this, Quotebar);

		var _this = _possibleConstructorReturn(this, (Quotebar.__proto__ || Object.getPrototypeOf(Quotebar)).call(this, props));

		var quotesFile = JSON.stringify([{ "quote": "Искреннее сердце — это драгоценность, которую никогда никуда не спрячешь.", "author": "Ходзе Сигэтоки (1198–1261) — монах, писатель" }, { "quote": "Глубоко постигни этот мир снов, который проходит в мгновение ока.", "author": "Ходзе Сигэтоки (1198–1261) — монах, писатель" }, { "quote": "Если ты раздумываешь, делать это или не делать, то, как правило, бывает лучше этого не делать.", "author": "Кэнко Хоси (Урабэ Канэеси) (1283–1350) — писатель" }, { "quote": "В высшей степени достойно сожаления, если самурай упускает момент, когда ему следует умереть.", "author": "Сиба Есимаса (1350–1419) — выдающийся администратор, полководец, поэт" }, { "quote": "Людей с острым умом следует искать среди тех, кто склонен думать.", "author": "Сиба Есимаса (1350–1419) — выдающийся администратор, полководец, поэт" }, { "quote": "Самурай должен умиротворять свое сердце и смотреть вглубь других. Вот высшее из всех боевых искусств.", "author": "Сиба Есимаса (1350–1419) — выдающийся администратор, полководец, поэт" }, { "quote": "Даже если у человека нет особых талантов, но он упорно овладевает знанием, он не опозорится перед другими.", "author": "Сиба Есимаса (1350–1419) — выдающийся администратор, полководец, поэт" }, { "quote": "Каждого человека следует использовать в соответствии с его способностями.", "author": "Сиба Есимаса (1350–1419) — выдающийся администратор, полководец, поэт" }, { "quote": "Природа человека устроена так, что учиться добру очень тяжело, а склоняться ко злу — легко, поэтому каждый постепенно становится похожим на тех, с кем он знаком.", "author": "Сиба Есимаса (1350–1419) — выдающийся администратор, полководец, поэт" }, { "quote": "Нет ничего более постыдного для человека, чем выходить из себя.", "author": "Сиба Есимаса (1350–1419) — выдающийся администратор, полководец, поэт" }, { "quote": "Несомненное достоинство — не стыдиться исправлять собственные ошибки. Первый же недостаток — вбить что-нибудь себе в голову, хорошее или плохое, и упрямо стоять на своем.", "author": "Сиба Есимаса (1350–1419) — выдающийся администратор, полководец, поэт" }, { "quote": "Даже если в ходе сражения ты видишь, что не сможешь победить, укрепи свое сердце и будь уверен, что никто не сможет превзойти тебя в стойкости.", "author": "Сиба Есимаса (1350–1419) — выдающийся администратор, полководец, поэт" }, { "quote": "В этом изменчивом мире следует идти по пути самодисциплины.", "author": "Сиба Есимаса (1350–1419) — выдающийся администратор, полководец, поэт" }, { "quote": "По-настоящему прозорливый человек всегда увидит и начало, и конец, и не станет пренебрегать даже мельчайшими деталями.", "author": "Такэда Сингэн (1521–1573) — великий полководец" }, { "quote": "Если люди дальновидны, находчивы и умеют оценить ситуацию, то какие бы трудности не стали перед ними, их слава будет жить в последующих поколениях.", "author": "Такэда Сингэн (1521–1573) — великий полководец" }, { "quote": "Учение для человека — все равно что ветви и листья для дерева. Без него он просто не сможет жить.", "author": "Такэда Сингэн (1521–1573) — великий полководец" }, { "quote": "Пусть твои воины не поносят врага. Древняя пословица гласит: «Разбуди пчелу, и она набросится на тебя с яростью дракона».", "author": "Такэда Нобусигэ (1525–1561) — воин" }, { "quote": "Никогда и ни при каких обстоятельствах не лги.", "author": "Такэда Нобусигэ (1525–1561) — воин" }, { "quote": "Не пренебрегай упреками в свою сторону.", "author": "Такэда Нобусигэ (1525–1561) — воин" }, { "quote": "Не сражайся за все подряд.", "author": "Такэда Нобусигэ (1525–1561) — воин" }, { "quote": "Никогда не показывай собственной слабости, даже в присутствии любящих тебя родственников и вассалов.", "author": "Такэда Нобусигэ (1525–1561) — воин" }, { "quote": "Не теряй себя из-за одной ошибки. Главное — не утратить впоследствии присутствия духа.", "author": "Такэда Нобусигэ (1525–1561) — воин" }, { "quote": "Даже если ты с кем-нибудь очень близок, хорошо подумай, прежде чем обратиться к нему с просьбой.", "author": "Такэда Нобусигэ (1525–1561) — воин" }, { "quote": "Знатен человек или низок по происхождению, но если он хотя бы раз не поставил на карту свою жизнь, у него есть повод устыдиться.", "author": "Набэсима Наосигэ (1538–1618) — самурай" }, { "quote": "Ум — это цветок проницательности. Но есть много примеров, когда цветы цветут, но не плодоносят.", "author": "Набэсима Наосигэ (1538–1618) — самурай" }, { "quote": "Во всех делах в первую очередь думай о человеке.", "author": "Набэсима Наосигэ (1538–1618) — самурай" }, { "quote": "Во всем надлежит действовать терпеливо.", "author": "Набэсима Наосигэ (1538–1618) — самурай" }, { "quote": "Если дела делаются с неохотой, семь из десяти окончатся неудачей.", "author": "Набэсима Наосигэ (1538–1618) — самурай" }, { "quote": "В сражении следует быть жестоким и безрассудным. Но забудь об этом в повседневной жизни.", "author": "Набэсима Наосигэ (1538–1618) — самурай" }, { "quote": "Если будешь отдавать свое сердце утонченному и изящному, то уподобишься женщине. Рожденный в доме самурая должен думать только о том, как взять короткий и длинный мечи и умереть.", "author": "Като Киемаса (1562–1611) — выдающийся полководец" }, { "quote": "Самурай, увлекающийся танцами, кои не входят в число боевых искусств, должен быть приговорен к сэппуку.", "author": "Като Киемаса (1562–1611) — выдающийся полководец" }, { "quote": "Самурай должен иметь доспехи, соответствующие его положению, платить своим слугам, а остальные деньги использовать для военных нужд.", "author": "Като Киемаса (1562–1611) — выдающийся полководец" }, { "quote": "Когда кто-то обнажает меч, он мысленно убивает человека.", "author": "Като Киемаса (1562–1611) — выдающийся полководец" }, { "quote": "Каждый изучает то, к чему имеет естественную склонность.", "author": "Миямото Мусаси (1584–1645) — легендарный самурай" }, { "quote": "Путь Воина есть решительное, окончательное и абсолютное принятие смерти.", "author": "Миямото Мусаси (1584–1645) — легендарный самурай" }, { "quote": "Смерть — самое важное обстоятельство в жизни Воина. Если ты живешь, свыкнувшись с мыслью о возможной гибели и решившись на нее, если думаешь о себе как о мертвом, слившись с идеей Пути Воина, то будь уверен, что сумеешь пройти по жизни так, что любая неудача станет невозможной, и ты исполнишь свои обязанности как должно…", "author": "Миямото Мусаси (1584–1645) — легендарный самурай" }, { "quote": "В бою состояние твоего духа не должно отличаться от повседневного. И в схватке, и в обыденной жизни ты должен быть целеустремлен, но спокоен.", "author": "Миямото Мусаси (1584–1645) — легендарный самурай" }, { "quote": "Если каждое утро и каждый вечер ты будешь готовить себя к смерти и сможешь жить так, словно твое тело уже умерло, ты станешь подлинным самураем. Тогда вся твоя жизнь будет безупречной, и ты преуспеешь на своем поприще.", "author": "Ямамото Цунэтомо (1659–1719) — самурай, автор трактата о самурайской этике «Сокрытое в листве»" }, { "quote": "Если ты появился на свет в старинном самурайском роду, достаточно лишь глубоко задуматься над верностью предкам, презреть тело и разум и всецело посвятить себя служению хозяину. Можно считать удачей, если ты, к тому же, наделен мудростью и талантами, и умеешь правильно воспользоваться ими.", "author": "Ямамото Цунэтомо (1659–1719) — самурай, автор трактата о самурайской этике «Сокрытое в листве»" }, { "quote": "Люди полагают, что, размышляя над сложными делами, они могут разобраться с ними. Однако, когда они задумываются над чем-нибудь, у них появляются ложные мысли. Они не могут принять правильное решение, потому что в своих рассуждениях руководствуются стремлением к личной выгоде.", "author": "Ямамото Цунэтомо (1659–1719) — самурай, автор трактата о самурайской этике «Сокрытое в листве»" }, { "quote": "Всю свою жизнь прилежно учись. Каждый день становись более искусным, чем ты был за день до этого, а на следующий день — более искусным, чем сегодня. Совершенствование не имеет конца.", "author": "Ямамото Цунэтомо (1659–1719) — самурай, автор трактата о самурайской этике «Сокрытое в листве»" }, { "quote": "Правильно поступает тот, кто относится к миру, словно к сновидению. Когда тебе снится кошмар, ты просыпаешься и говоришь себе, что это был всего лишь сон.", "author": "Ямамото Цунэтомо (1659–1719) — самурай, автор трактата о самурайской этике «Сокрытое в листве»" }, { "quote": "Тот, кто знает очень мало, будет напускать на себя вид знатока. Это говорит о его неопытности. Если человек что-то хорошо знает, об этом по нему не скажешь. Такой человек ведет себя благопристойно.", "author": "Ямамото Цунэтомо (1659–1719) — самурай, автор трактата о самурайской этике «Сокрытое в листве»" }, { "quote": "Очень расчетливый ум не достоин уважения. Рассчитывать — это значит взвешивать и помнить, что можно потерять и что нужно выиграть. Расчетливый ум никогда не сможет подняться над мыслью о корысти и убытках. А что есть смерть, как не убыток? Что есть жизнь, как не корысть? Кто рассчитывает, тот корыстен. Поскольку такой человек в любых обстоятельствах работает только с корыстной целью, — он должен опасаться смерти. Значит, такой человек — трус.", "author": "Ямамото Цунэтомо (1659–1719) — самурай, автор трактата о самурайской этике «Сокрытое в листве»" }, { "quote": "Я постиг, что Путь Самурая — это смерть. В ситуации «или — или» без колебаний выбирай смерть. Это нетрудно. Исполнись решимости и действуй.", "author": "Ямамото Цунэтомо (1659–1719) — самурай, автор трактата о самурайской этике «Сокрытое в листве»" }, { "quote": "Самурай должен всегда помнить — помнить днем и ночью, с того дня, когда он берет в руки палочки, находясь в предвкушении новогодней трапезы, до последней ночи уходящего года, когда он платит оставшиеся долги, — помнить о том, что он должен умереть.", "author": "Ямамото Цунэтомо (1659–1719) — самурай, автор трактата о самурайской этике «Сокрытое в листве»" }, { "quote": "Чтобы подняться более высоко, упражняйся всегда, что бы не случилось с тобой.", "author": "Ямамото Цунэтомо (1659–1719) — самурай, автор трактата о самурайской этике «Сокрытое в листве»" }, { "quote": "Жизнь — это мгновение за мгновением, и мера вашей жизни — то, как ваш дух расцветает в каждое из этих мгновений.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Смысл победы в отсутствии конфликта. Смысл отсутствия конфликта в отсутствии отделенности.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Никогда не знать поражения означает никогда не вступать в борьбу.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Подобно тому, как Природа любит и защищает все свои создания и помогает всему сущему расти и развиваться, так и айкидо ведет каждого, кто посвящает себя ему, по пути познания своих истин, предоставляя эту возможность со всей своей искренностью.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Айкидо — это лекарство для больного мира. В мире есть зло и беспорядок, потому что люди забыли о том, что все вещи происходят из одного источника. Возвратись к этому источнику и оставь все эгоистические мысли, пустячные желания и гнев.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Двигайся, как луч света, летай, как молния, бей, как гром, вращайся вокруг устойчивого центра.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Техники требуют четырех качеств, в которых отражается природа нашего мира. В зависимости от обстоятельств, ты должен быть: твердым, как алмаз, гибким, как ива, плавным, как течение воды, или пустым, как небо.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Когда противник идет вперед, выходи навстречу и приветствуй его. Если он хочет отойти, проводи его.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Положитесь на величие того, кто правит этим миром и смело идите вперед.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Всегда старайся быть в союзе с небом и землей; тогда будешь видеть мир в истинном свете. Самодовольство исчезнет, и ты сможешь поглощать в себя любое нападение.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Созерцай устройство этого мира, слушай слова мудрых и принимай все хорошее и доброе как свое. Опираясь на это, открой свою собственную дверь к истине. Не прогляди истину, которая прямо перед тобой. Все вокруг… должно стать твоим учителем.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Кем не владеет ничто, тот владеет всем.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Все законы неба и земли живут в тебе.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Правильная поза тела отражает правильное состояние ума.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Не веди бесполезные разговоры, познавай посредством практики.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Если ты испытываешь других, соревнуешься с ними, критикуешь их — это приводит к твоему ослаблению и поражению.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "В железной руде много шлаков, ослабляющих ее свойства; плавкой, ковкой и закалкой железо превращают в сталь, и затем придают ей форму острого, как бритва, меча. Человеческие существа развиваются в той же последовательности.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Необходимо разработать стратегию, которая использовала бы все доступные физические условия и элементы. Лучшая стратегия — это та, которая полагается на неограниченный диапазон реакций.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Если твое сердце велико, чтобы принять противников, ты можешь видеть их насквозь и избегать нападений. И тогда ты сможешь направлять их по пути, указанному тебе небом и землей.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Свободный от слабости, не обращай внимания на яростные атаки своих врагов: иди и действуй!", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Не взирай на этот мир со страхом и отвращением. Смело смотри в лицо тому, что предлагают тебе боги.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Выйди за пределы жизни и смерти, и тогда сможешь пройти через все кризисы спокойно и безопасно.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Неудача — залог успеха; каждая ошибка чему-то учит нас.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "В нашей технике мы полностью входим в атаку противника, совершенно растворяемся в ней и решительно ею управляем.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Видя меня перед собой, враг нападает, но к этому времени я уже стою за его спиной.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Твой дух есть твой истинный щит.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Побеждай своих противников духовно, заставив их осознать бессмысленность их действий. Путь Воина заключается в том, чтобы устанавливать гармонию.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "В конце концов, ты должен будешь вообще забыть о технике. Чем дальше продвигаешься, тем меньше остается догм. Великий Путь — это, на самом деле, Отсутствие Пути.", "author": "Морихэй Уэсиба (1883–1969) — основатель современного айкидо" }, { "quote": "Азарт в игре сильнее страсти в любви.", "author": "японская пословица" }, { "quote": "Алмазу нужна шлифовка, человеку — образование.", "author": "японская пословица" }, { "quote": "Без предмета нет и тени.", "author": "японская пословица" }, { "quote": "Без хорошего хода в шахматы не выиграешь.", "author": "японская пословица" }, { "quote": "В долине вся вода в один ручей стекается.", "author": "японская пословица" }, { "quote": "Выигрываешь — хочется выиграть еще; проигрываешь — хочется отыграться.", "author": "японская пословица" }, { "quote": "Если хочешь убить полководца, убей сначала его коня.", "author": "японская пословица" }, { "quote": "Есть терпение — будет и умение.", "author": "японская пословица" }, { "quote": "Завтра будет дуть завтрашний ветер.", "author": "японская пословица" }, { "quote": "Зеркало разума тоже тускнеет.", "author": "японская пословица" }, { "quote": "Лунная ночь и вареный рис всегда бывают кстати.", "author": "японская пословица" }, { "quote": "Быстро - это медленно без остановок.", "author": "японская пословица" }]);

		_this.quotes = JSON.parse(quotesFile);
		_this.changeQuoteTimer = null;

		_this.state = {
			currentQuote: _this.quotes[Math.floor(Math.random() * _this.quotes.length)]
		};
	...
	_createClass(Quotebar, [{
		...
		value: function render() {
			...
			var quotebarClass = 'quotebar ' + (this.props.quotesSwitchedOff ? 'quotebar_hidden' : 'quotebar_shown');

			var quoteText = '"' + this.state.currentQuote.quote + '"';
			var quoteAuthor = this.state.currentQuote.author;

			return _react2.default.createElement(
				"div",
				{ className: quotebarClass },
				_react2.default.createElement(
					"div",
					{ className: "quotebar__quote" },
					quoteText
				),
				_react2.default.createElement(
					"div",
					{ className: "quotebar__author" },
					quoteAuthor
				)
			);
		}
...
exports.default = Quotebar;

/***/ }),

/***/ "./src/js/components/display/tablo.js":
/*!********************************************!*\
  !*** ./src/js/components/display/tablo.js ***!
  \********************************************/
/*! no static exports found */
...
var Tablo = function (_Component) {
	...
	_createClass(Tablo, [{
		...
		value: function render() {
			...
			var tabloClass = 'tablo ' + (this.props.className ? this.props.className : '');
			var whoWins = this.props.totalOfGame == 'standoff' ? 'Ничья!' : this.props.totalOfGame == 'user' ? 'Вы выиграли!' : 'Вы проиграли!';
			var score = this.props.userColor == 'white' ? this.props.blackActorsCount + ' : ' + this.props.whiteActorsCount : this.props.whiteActorsCount + ' : ' + this.props.blackActorsCount;
...
/***/ "./src/js/components/display/toolbar.js":
/*!**********************************************!*\
  !*** ./src/js/components/display/toolbar.js ***!
  \**********************************************/
/*! no static exports found */
...
var Toolbar = function (_Component) {
	...
	_createClass(Toolbar, [{
		key: 'switchStartHandle',
		value: function switchStartHandle(event) {
			//event.preventDefault();
		...
		key: 'resetHandle',
		value: function resetHandle(event) {
			//event.preventDefault();
		...
		value: function render() {
			...
			var elementIsDisabled = void 0;
			var itemClass = void 0;
			var switchStartBtnText = void 0;
			var switchStartBtnClass = void 0;
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					null,
					_react2.default.createElement('input', { name: 'quotesSwitchedOff', type: 'checkbox', className: 'bar_enabled-item', checked: this.props.quotesSwitchedOff, onChange: this.changeData }),
					'\u0412\u044B\u043A\u043B\u044E\u0447\u0438\u0442\u044C \u0446\u0438\u0442\u0430\u0442\u044B'
				),
				_react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						'select',
						{ name: 'userColor', className: itemClass, disabled: elementIsDisabled, onChange: this.changeData, value: this.props.userColor },
						_react2.default.createElement(
							'option',
							{ value: 'white' },
							'\u0431\u0435\u043B\u044B\u0435'
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'select',
						{ name: 'level', className: itemClass, disabled: elementIsDisabled, onChange: this.changeData, value: this.props.level },
						_react2.default.createElement(
							'option',
							{ value: 'easy' },
							'\u043B\u0435\u0433\u043A\u0438\u0439'
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'select',
						{ name: 'mode', className: itemClass, disabled: elementIsDisabled, onChange: this.changeData, value: this.props.mode },
						'>',
						_react2.default.createElement(
							'option',
							{ value: 'classic' },
						...
						_react2.default.createElement(
							'option',
							{ value: 'dam' },
							'\u0438\u0433\u0440\u0430\u0442\u044C \u0442\u043E\u043B\u044C\u043A\u043E \u0434\u0430\u043C\u043A\u0430\u043C\u0438'
						)
					)
				),
				_react2.default.createElement(
					'button',
					{ name: 'resetBtn', className: 'bar__button button ' + itemClass, disabled: elementIsDisabled, onClick: this.resetHandle },
					'\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438 \u043F\u043E \u0443\u043C\u043E\u043B\u0447\u0430\u043D\u0438\u044E'
				),
				_react2.default.createElement(
					'button',
					{ name: 'switchStartBtn', className: 'bar__button button bar_enabled-item ' + switchStartBtnClass, onClick: this.switchStartHandle },
					switchStartBtnText
				)
			);
		}
...
var content = __webpack_require__(/*! !../../node_modules/css-loader??ref--5-1!../../node_modules/postcss-loader/src??ref--5-2!../../node_modules/less-loader/dist/cjs.js!./template.less */ "./node_modules/css-loader/index.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/less-loader/dist/cjs.js!./src/less/template.less");
